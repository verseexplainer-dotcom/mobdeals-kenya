...
- [x] Run production build before deployment. Latest verified build generated 298 static pages on 2026-09-20.
...
- [x] Keep container publishing workflow separate from primary Cloudflare Pages frontend deployment.
