...
- [x] Finalize initial design tokens against `docs/design-references/DESIGN.md`.
- [x] Build shared navigation components.
- [x] Build homepage sections.
- [x] Build product grid and detail page patterns.
...
- [ ] Confirm Cloudflare Pages production project and rollback flow from the Cloudflare dashboard.
